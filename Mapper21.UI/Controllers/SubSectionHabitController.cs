...
namespace Mapper21.UI.Controllers
{
    public class SubSectionHabitController : BaseController
    {
        ...
        public ActionResult Habit_Read(int parentId, [DataSourceRequest] DataSourceRequest request)
        {
            IQueryable<SubSectionHabit> habits = db.SubSectionHabits.Where(h => h.SubSectionId == parentId);
        ...
        public ActionResult Habit_Destroy(int parentId, [DataSourceRequest] DataSourceRequest request,
            HabitSubSectionViewModel habit)
        {
            if (ModelState.IsValid)
            {
